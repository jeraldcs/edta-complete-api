...
def register_webhook_v1(request: WebhookRegistrationRequest):
    return app_container.container.event_bus.register_webhook(request.target_url, request.event_types)
